...
class COCODataset(JointsDataset):
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        self.bbox_file = cfg.TEST.COCO_BBOX_FILE  # '/data/dataset/COCO_2017/COCO_val2017_detections_AP_H_56_person.json'
        self.use_gt_bbox = cfg.TEST.USE_GT_BBOX  # True
        self.image_width = cfg.MODEL.IMAGE_SIZE[0]  # 288
        self.image_height = cfg.MODEL.IMAGE_SIZE[1]  # 384
        self.aspect_ratio = self.image_width * 1.0 / self.image_height  # 0.75
        self.pixel_std = 200
        ...
        self._class_to_ind = dict(zip(self.classes, range(self.num_classes)))  # {'__background__': 0, 'stand': 1}
        self._class_to_coco_ind = dict(zip(cats, self.coco.getCatIds()))  # {'stand': 1}
        ...
        self.lower_body_ids = (4, 5, 6, 7, 8, 9)
