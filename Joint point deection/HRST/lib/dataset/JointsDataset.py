...
class JointsDataset(Dataset):
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        self.root = root  # '../data/dataset/COCO_2017'
        self.image_set = image_set  # 'train2017'

        self.output_path = cfg.OUTPUT_DIR  # 'output'
        self.data_format = cfg.DATASET.DATA_FORMAT  # jpg

        self.scale_factor = cfg.DATASET.SCALE_FACTOR  # 0.35
        self.rotation_factor = cfg.DATASET.ROT_FACTOR  # 45
        self.flip = cfg.DATASET.FLIP  # True
        self.num_joints_half_body = cfg.DATASET.NUM_JOINTS_HALF_BODY  # 8
        self.prob_half_body = cfg.DATASET.PROB_HALF_BODY  # 0.3
        self.color_rgb = cfg.DATASET.COLOR_RGB  # True

        self.target_type = cfg.MODEL.TARGET_TYPE  # 'gaussian'
        self.image_size = np.array(cfg.MODEL.IMAGE_SIZE)  # [288 384]
        self.heatmap_size = np.array(cfg.MODEL.HEATMAP_SIZE)  # [72 96]
        self.sigma = cfg.MODEL.SIGMA  # 3
        self.use_different_joints_weight = cfg.LOSS.USE_DIFFERENT_JOINTS_WEIGHT  # False
