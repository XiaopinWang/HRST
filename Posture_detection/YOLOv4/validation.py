...
def main(parser_data):
    ...
    with torch.no_grad():
        for imgs, targets, paths, shapes, img_index in tqdm(val_dataset_loader, desc="validation..."):
            ...
            pred = non_max_suppression(pred, conf_thres=0.3, iou_thres=0.6, multi_label=False)  # (9,7)
            # pred = non_max_suppression(pred, conf_thres=0.01,  nms_thres=0.6)  # (69, 7)
            outputs = []
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='D:\pig_gesture\pig_voc\yolo_type/my_data.data', help='*.data path')
    parser.add_argument('--hyp', type=str, default='cfg/hyp.yaml', help='hyperparameters path')
    parser.add_argument('--img-size', type=int, default=832, help='test size')

    # 训练好的权重文件
    parser.add_argument('--weights', default='./weights/final185.pt', type=str, help='training weights')
    # parser.add_argument('--weights', default='./weights/final_yolov4spp-193.pt', type=str, help='training weights')
    # batch size
