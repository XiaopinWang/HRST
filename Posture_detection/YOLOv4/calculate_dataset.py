...
# train_annotation_dir = r"D:\pig_gesture\pig_voc\yolo_type\train\labels"
# val_annotation_dir = r"D:\pig_gesture\pig_voc\yolo_type\val\labels"
# test_annotation_dir = r"D:\pig_gesture\pig_voc\yolo_type\test\labels"
# train_annotation_dir = "./my_yolo_dataset_pig/train/labels"
# val_annotation_dir = "./my_yolo_dataset_pig/val/labels"
...
def create_data_data(create_data_path, label_path, train_path, val_path, test_txt_path,classes_info):
    ...
    with open(create_data_path, "w") as w:
        ...
        w.write("test={}".format(test_txt_path) + "\n")   # 记录验证集对应txt文件路径
        w.write("names=data/my_data_label.names" + "\n")        # 记录label.names文件路径


def change_and_create_cfg_file(classes_info, save_cfg_path="./cfg/my_yolov4.cfg"):
    ...
    # TODO YOLOv4
    filters_lines = [961, 1049, 1137]
    classes_lines = [968, 1056, 1144]
...
def main():
    ...
    # train_txt_path = "D:\pig_gesture\pig_voc\yolo_type\my_train_data.txt"
    # val_txt_path = "D:\pig_gesture\pig_voc\yolo_type\my_val_data.txt"
    # test_txt_path = "D:\pig_gesture\pig_voc\yolo_type\my_test_data.txt"
    ...
    # create_data_data("D:\pig_gesture\pig_voc\yolo_type/my_data.data", classes_label, train_txt_path, val_txt_path, test_txt_path, classes_info)
