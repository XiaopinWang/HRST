...
from backbone import mobilenetv3_fpn
...
def create_model(num_classes):
    ...
    #                                  trainable_layers=3)
    backbone = mobilenetv3_fpn.mobilenet_fpn_backbone(pretrain_path="./backbone/mobilenet_v3_large-8738ca79.pth")
    # 训练自己数据集时不要修改这里的91，修改的是传入的num_classes参数
    model = FasterRCNN(backbone=backbone, num_classes=91)
    # 载入预训练模型权重
    # https://download.pytorch.org/models/fasterrcnn_resnet50_fpn_coco-258fb6c6.pth
    #weights_dict = torch.load("./try_v3/model_1.pth", map_location='cpu')
...
if __name__ == "__main__":
    ...
    # 文件保存地址
    parser.add_argument('--output-dir', default='./multi_train_v3_final', help='path where to save')
    # 基于上次的训练结果接着训练
    parser.add_argument('--resume', default='./try_v3/model_1.pth', help='resume from checkpoint')
