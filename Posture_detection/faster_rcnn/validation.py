...
from backbone import resnet50_fpn_backbone, ConvNeXt_fpn, efficv2_fpn, mobilenetv3_fpn
...
if __name__ == "__main__":
    ...
    # 数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='D:\pig_gesture\pig_voc', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights', default='./log_result/mov3_final.pth', type=str, help='training weights')
