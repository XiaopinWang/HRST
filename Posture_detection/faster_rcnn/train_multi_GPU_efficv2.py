...
from backbone import efficv2_fpn
...
def create_model(num_classes):
   ...
   # backbone = efficv2_fpn.mobilenet_fpn_backbone(pretrain_path="./backbone/pre_efficientnetv2-m.pth")
    ...
    backbone = efficv2_fpn.mobilenet_fpn_backbone(pretrain_path="./backbone/pre_efficientnetv2-s.pth")
...
if __name__ == "__main__":
    ...
    # 文件保存地址
    parser.add_argument('--output-dir', default='./multi_train_v2', help='path where to save')
    # 基于上次的训练结果接着训练
