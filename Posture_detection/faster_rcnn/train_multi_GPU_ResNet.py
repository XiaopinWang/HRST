...
def main(args):
    ...
    # 用来保存coco_info的文件
    results_file = "ResNet_results{}.txt".format(datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
...
if __name__ == "__main__":
    ...
    # 文件保存地址
    parser.add_argument('--output-dir', default='./multi_train_ResNet', help='path where to save')
    # 基于上次的训练结果接着训练
